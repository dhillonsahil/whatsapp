...
function ChatLIstItem({isContactPage=false,data}) {
  ...
  return <div className={`flex  cursor-pointer items-center hover:bg-background-default-hover`} onClick={handleContactClick}>
    ...
    <div className="min-h-full flex-col justify-center mt-3 pr-2 w-full">
      <div className="flex justify-between">
        ...
        </div>
        {
         !isContactPage &&
         <div>
          <span className={`${!data.totalUnreadMessaged>0 ? "text-secondary":"text-icon-green"} text-sm`}>
            {
        ...
        <div className="flex border-b border-conversation-border pb-2 pt-1 pr-3">
          <div className="flex justify-between w-full">
            <span className="text-secondary line-clamp-1 text-sm">
              ...
              <div className="flex items-center gap-1 max-w-[200px] sm:max-2-[250px] md:max-w-[300px] lg:max-w-[200px] xl:max-w-[300px] ">
                {
              ...
              {
                data.totalUnreadMessaged>0 && <span className="bg-icon-green px-[5px] rounded-full text-sm">{data.totalUnreadMessaged}</span>
              }
          </div>
        </div>
